...
if ($database_url_from_config) {
    //VALUES FROM ENVIRONMENT VARIABLES
		$config = array(
    'sqlhost' => $database_url_from_config['host'],
    'sqluser' => $database_url_from_config['user'],
    'sqlpass' => $database_url_from_config['pass'],
    'database' => substr($database_url_from_config["path"], 1)
    );
} else {
